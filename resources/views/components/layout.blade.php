...
<html lang="en">
  ...
  <body>
    ...
    <footer class="border-top text-center small text-muted py-3">
        ...
        @auth
          <div data-username="{{auth()->user()->username}}" data-avatar="{{auth()->user()->avatar}}" id="chat-wrapper" class="chat-wrapper shadow border-top border-left border-right border-bottom"></div>
        @endauth
